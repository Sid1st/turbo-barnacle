...
from config import PROTECT_CONTENT, Var, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, AUTO_DELETE_TIME, AUTO_DELETE, ADMINS, VERIFY, VERIFY_TUTORIAL, BOT_USERNAME
import re
import json
import base64
...
async def start(bot, update):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 REQUEST GROUP', url='https://t.me/+bjpOokcIj082NGE1')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/+fNGvkfXhsQVkZjI1'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/MoviesXonee')
            ],[
...
# Ask Doubt on telegram ..
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/https://t.me/+fNGvkfXhsQVkZjI1'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/MoviesXonee')
            ],[
            InlineKeyboardButton('🤖 ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ', callback_data='clone')
            ],[
